...
public class MapperPlugin extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document,
        ...
        select.addAttribute(new Attribute("parameterType", introspectedTable
                .getBaseRecordType()));
        ...
        for (GeneratedJavaFile javaFile : introspectedTable
            ...
            if (shortName.endsWith("Mapper")) { // 扩展Mapper
                if (StringUtility.stringHasValue(expandDaoTargetPackage)) {
                    ...
                    mapperJavafile = new GeneratedJavaFile(mapperInterface,
                            daoTargetDir, javaFormatter);
                    try {
                        File mapperDir = shellCallback.getDirectory(
                                daoTargetDir, daoTargetPackage);
                ...
                mapperInterface.addJavaDocLine("/**");
                mapperInterface
                        .addJavaDocLine(" * 由MyBatis Generator工具自动生成，请不要手动修改");
                mapperInterface.addJavaDocLine(" */");
