...
public class MybatisControllerPlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
        ...
        constructor.addBodyLine(new StringBuilder("this.obj = new ")
                .append(topLevelClass.getType().getShortName()).append("();")
                .toString());
        ...
        for (Field field : fields) {
            ...
            method.addBodyLine(new StringBuilder().append("obj.")
                    .append(field.getName()).append(" = ")
                    .append(field.getName()).append(";").toString());
            method.addBodyLine(new StringBuilder().append("return this;")
                    .toString());
        ...
        context.getCommentGenerator().addGeneralMethodComment(build,
                introspectedTable);
    ...
    private static final class Config extends BasePluginConfig {
        ...
        private Config(Properties props) {
            super(props);
            this.builderClassName = props.getProperty(builderClassNameKey,
                    "Builder");
        }
    }
