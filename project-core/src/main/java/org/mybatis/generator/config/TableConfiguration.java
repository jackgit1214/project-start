...
public class TableConfiguration extends PropertyHolder {
    ...
    public XmlElement toXmlElement() {
        ...
        if (!createActionEnabled) {
            xmlElement.addAttribute(new Attribute("enableCreateAction", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    public boolean isCreateActionEnabled() {
        return createActionEnabled;
    }

    public void setCreateActionEnabled(boolean createActionEnabled) {
