...
public class MyBatisGeneratorConfigurationParser {
    ...
    protected void parseTable(Context context, Node node) {
        ...
        String enableCreateAction = attributes.getProperty("enableCreateAction");
        ...
        if (stringHasValue(enableCreateAction)) {
            tc.setCreateActionEnabled(isTrue(enableCreateAction));
     ...
     * properties, properties loaded from the <properties> configuration element,
     * and "extra" properties that may be supplied by the Maven or Ant
     * envireonments.
     * <p>
