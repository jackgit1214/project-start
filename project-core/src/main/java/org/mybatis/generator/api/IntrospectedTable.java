...
public abstract class IntrospectedTable {
    ...
    protected String calculateJavaModelPackage() {
        ...
        sb.append(config.getTargetPackage());
        sb.append(fullyQualifiedTable
                .getSubPackageForModel(isSubPackagesEnabled(config)));
    ...
    protected void calculateModelAttributes() {
        ...
        // 这里如果有别名，应用别名，驼峰生成规则的问题
        // sb.append(fullyQualifiedTable.getDomainObjectName());
        // if (fullyQualifiedTable.getAlias() != null
        // && !"".equals(fullyQualifiedTable.getAlias()))
        // sb.append(fullyQualifiedTable.getAlias());
        // else
        // sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append(fullyQualifiedTable.getDomainObjectName());
