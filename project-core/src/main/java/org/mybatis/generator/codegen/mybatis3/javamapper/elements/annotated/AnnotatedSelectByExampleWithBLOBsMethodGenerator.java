...
public class AnnotatedSelectByExampleWithBLOBsMethodGenerator extends
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        interfaze
                .addImportedType(new FullyQualifiedJavaType("org.apache.ibatis.annotations.SelectProvider")); //$NON-NLS-1$
        ...
        if (introspectedTable.isConstructorBased()) {
            ...
            interfaze
                    .addImportedType(new FullyQualifiedJavaType("org.apache.ibatis.annotations.ConstructorArgs")); //$NON-NLS-1$
        } else {
